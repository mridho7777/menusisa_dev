...
Future<void> showProductFormPage(BuildContext context, {ProdukModel? product}) {
    ...
    builder: (dialogContext) => Dialog(
      ...
      child: ProductFormPage(
        ...
        onSave: (savedProduct) async {
          ...
          if (workspace.storeId.isEmpty) {
            await workspace.loadData();
          }
          final merchantId = workspace.storeId;
          final ok = product == null
              ? await controller.addProduct(savedProduct, merchantId: merchantId)
              : await controller.updateProduct(savedProduct, merchantId: merchantId);
          if (!ok) return;
          notifController.addNotification(
            title: product == null
                ...
                : 'Produk Diperbarui',
            description:
                'Produk "${savedProduct.nama}" (ID: ${savedProduct.id}) berhasil ${product == null ? 'ditambahkan' : 'diperbarui'}.',
            iconKey: product == null ? 'check' : 'edit',
          );
...
class ProductFormPage extends StatefulWidget {
  ...
  final Future<void> Function(ProdukModel) onSave;
