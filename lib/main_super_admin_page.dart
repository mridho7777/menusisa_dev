...
class MenuSisaApp extends StatefulWidget {
  const MenuSisaApp({super.key});

  @override
  State<MenuSisaApp> createState() => _MenuSisaAppState();
}

class _MenuSisaAppState extends State<MenuSisaApp> {
  ...
  Future<void> _refreshData() async {
    ...
    await Future.wait([
      ...
      revenueProvider.loadRevenues(),
      notificationsProvider.loadNotifications(),
      activityLogProvider.loadLogs(),
      systemSettingsProvider.loadSettings(),
