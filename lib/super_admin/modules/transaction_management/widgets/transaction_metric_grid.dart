...
class TransactionMetricGrid extends StatelessWidget {
  const TransactionMetricGrid({super.key, required this.metrics});

  final List<TransactionMetric> metrics;
...
class _MetricCard extends StatelessWidget {
  ...
  final TransactionMetric metric;
  final int delay;
