...
class CommissionMetricGrid extends StatelessWidget {
  const CommissionMetricGrid({super.key, required this.metrics});

  final List<CommissionMetric> metrics;
...
class _MetricCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final icon = switch (metric.icon) {
      ...
      'month' => Icons.calendar_month_rounded,
