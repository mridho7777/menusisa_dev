...
class PaymentMetricGrid extends StatelessWidget {
  const PaymentMetricGrid({super.key, required this.metrics});

  final List<PaymentMetric> metrics;
