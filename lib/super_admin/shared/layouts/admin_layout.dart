    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final sidebarOpen = !provider.sidebarCollapsed;
                  ...
                  child: Stack(
                    children: [
                      ...
                      AnimatedPositioned(
                        duration: _animationDuration,
                        curve: Curves.easeInOutCubicEmphasized,
                        left: sidebarOpen ? _sidebarWidth : 0,
                        top: 0,
                        right: 0,
                        bottom: 0,
                        child: Column(
                          children: [
                            SizedBox(height: _headerHeight, child: MainHeader(sidebarOpen: sidebarOpen, forcedCompact: false)),
                            Expanded(
                              child: Container(
